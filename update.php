    ...
    <div class="container">
        ...
        <form method="post" action="update.php?id=<?php echo $id; ?>">
            ...
            <div class="control-group<?php echo !empty($metierError) ? 'error' : ''; ?>">
                ...
                <br />
                <div class="controls">
                    Dev : <input type="checkbox" name="metier" value="dev" <?php if (isset($metier) && $metier == "dev")
                        echo "checked"; ?>>
                    Integrateur <input type="checkbox" name="metier" value="integrateur" <?php if (isset($metier) && $metier == "integrateur")
                        echo "checked"; ?>>
                    Reseau <input type="checkbox" name="metier" value="reseau" <?php if (isset($metier) && $metier == "reseau")
                        echo "checked"; ?>>
                </div>
                <p>
            ...
            <div class="control-group <?php echo !empty($commentError) ? 'error' : ''; ?>">
                ...
                <br />
                <div class="controls">
                    <textarea rows="4" cols="30" name="comment"><?php if (isset($comment))
